...
public class Card {
	...
	private int myIcon, mySize, myGroup, myBracket;
	/**
	...
	private String brackets[] = {"{}", "[]", "<>"};
	 ...
	 {
		 return icons[myIcon] + sizes[mySize] + groups[myGroup] + brackets[myBracket];
	 }
	/**
